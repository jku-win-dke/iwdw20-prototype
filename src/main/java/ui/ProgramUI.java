...
public class ProgramUI {
	...
	public static void main(String[] args) {
		...
		DataUserSimulator.requestDataset(1, "DexG5MobRec_SM64305440", "2017-02-04", "2017-02-06");
		DataUserSimulator.requestDataset(2, "DexG5MobRec_SM64305440", "2017-02-04", "2017-02-04");
		DataDetectiveSimulator.detectLeakage("requestedDataset_by1_DexG5MobRec_SM64305440_2017-02-04_2017-02-06.json",
				0.01, 0.01, 2);
	}
}
